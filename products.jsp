                        ...
                        <div class="col-md-3 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    ...
                                    <img src="./uploads/<%=retriveProduct.getString("image")%>" alt="" class="pro-image-front">
                                    <img src="./uploads/<%=retriveProduct.getString("image")%>" alt="" class="pro-image-back"> <span class="product-new-top">New</span>
                                </div>
                                <div class="item-info-product ">
                                    ...
                                    <h5>
                                     ...
                                     <h6>
                                        Likes: <%=retriveProduct.getInt("likestatus")%>
                                    </h6>
                                    <div class="info-product-price">
                                        <input type="hidden" name="price" value="<%=retriveProduct.getString("price")%>">
                                        <input type="hidden" name="product" value="<%=retriveProduct.getString("product_category")%>">
                                    ...
                                    <input type="submit" value="Add to cart" class="btn btn-warning" onclick="return confirm('Are you sure Do you want to add this item in cart?');">
                                        ...
                                        <form method ="post" action ="Like">
                                            ...
                                            <input type="hidden" name="id" value="<%=retriveProduct.getInt("id")%>">
                                            <input type="hidden" name="new" value="<%=retriveProduct.getInt("likestatus")+1%>">
                                            <input type="hidden" name="orig" value="<%=retriveProduct.getInt("likestatus")%>">
