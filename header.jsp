...
<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav menu__list">
        ...
        <li class="menu__item"><a class="menu__link" href="logout.jsp">Logout</a></li>
            ...
            %>
        <li class="menu__item"><a class="menu__link" href="customer-login.jsp">Login</a></li>
        <li class="menu__item"><a class="menu__link" href="customer-register.jsp">Register</a></li>
