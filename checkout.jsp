                    ...
                    <table class="table table-bordered">
                        ...
                        <tr class="rem1">
                            ...
                            <td class="invert">
                                <div class="quantity">
                                    <div class="quantity-select">
                                        <form action="UpdateProductQuantity" method="post">
                                            <input type="hidden" value="<%=totalProduct.getInt("product_id")%>"
                                                   name="productId"> <input type="number"
                                                   name="quantity" value="<%=totalProduct.getInt("quantity")%>"
                             ...
                             <td class="invert"><%=totalProduct.getString("category")%>&nbsp;</td>
                           
                            <td class="invert"><%=totalProduct.getString("total_price")%>&nbsp;</td>
                            
                            <td class="invert"><a
                                    href="removeProductFromCart.jsp?productId=<%=totalProduct.getInt("product_id")%>"
